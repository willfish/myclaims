defmodule MyclaimsWeb.Coherence.ViewHelpers do
  @moduledoc """
  ...
  @seperator {:safe, "&nbsp; | &nbsp;"}
  @helpers MyclaimsWeb.Router.Helpers
  ...
  * :register - customize the register link text (#{@register_link})
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(MyclaimsWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(MyclaimsWeb.Gettext, "errors", msg, opts)
    end
  end
